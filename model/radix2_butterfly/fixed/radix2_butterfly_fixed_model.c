#include "radix2_butterfly_fixed_model.h"
...
static radix2_butterfly_fixed_cpx_q2_14_t fixed_stage_calc_twiddle(int twiddle_index) {
    radix2_butterfly_fixed_cpx_q2_14_t twiddle;
...
static fixed_stage_cpx_i64_t fixed_stage_complex_mul_q16_0_q2_14(
    radix2_butterfly_fixed_cpx_q16_0_t x_q16_0,
    radix2_butterfly_fixed_cpx_q2_14_t y_q2_14
) {
...
radix2_butterfly_fixed_output_t radix2_butterfly_fixed_step(
    ...
    radix2_butterfly_fixed_cpx_q2_14_t twiddle_q2_14 = fixed_stage_calc_twiddle(current_twiddle_index);
    ...
    // Формирование выхода
    radix2_butterfly_fixed_output_t output = {
        .last = last_i,
