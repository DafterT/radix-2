...
#define FFT64_FIXED_TWIDDLE_COUNT (FFT64_CORE_SIZE / 2)
...
static fft64_fixed_cpx_i64_t fft64_fixed_complex_mul_q16_0_q2_14(
    fft64_core_cpx_q16_0_t x_q16_0,
...
void fft64_core_fixed_div2_butterfly(
    ...
    fft64_fixed_cpx_i64_t scaled_sum_q21_6 = sum_q21_6;
    fft64_fixed_cpx_i64_t scaled_diff_q21_6 = diff_q21_6;

    if (apply_div2) {
        scaled_sum_q21_6.re >>= 1;
        scaled_sum_q21_6.im >>= 1;
        scaled_diff_q21_6.re >>= 1;
        scaled_diff_q21_6.im >>= 1;
    }

    fft64_fixed_cpx_i64_t top_out_q22_23 = {
        .re = scaled_sum_q21_6.re << 17,
        .im = scaled_sum_q21_6.im << 17
    };
    fft64_fixed_cpx_i64_t bottom_out_q22_23 = {
        .re = scaled_diff_q21_6.re << 17,
        .im = scaled_diff_q21_6.im << 17
    };
